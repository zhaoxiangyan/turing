                ...
                <div class="find_box">
                    <div>
                        <div class="phone-find">
                            ...
                            <p><input type="text" id="imgCode" placeholder="请输入图形验证码" v-model="img_code"> <img src="https://turingtechcn.com/turingcloud/captcha/gen" id="veriImg" class="areaNum graph" onclick="this.src='https://turingtechcn.com/turingcloud/captcha/gen?random='+Math.random()"></p>
